      ...
      export HDFS_NAMENODE_OPTS="$HDFS_NAMENODE_OPTS -Djava.security.auth.login.config=/usr/hdp/3.1.0.0-78/hadoop/conf/hdfs_nn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      export HDFS_SECONDARYNAMENODE_OPTS="$HDFS_SECONDARYNAMENODE_OPTS -Djava.security.auth.login.config=/usr/hdp/3.1.0.0-78/hadoop/conf/hdfs_nn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      export HDFS_DATANODE_OPTS="$HDFS_DATANODE_OPTS -Djava.security.auth.login.config=/usr/hdp/3.1.0.0-78/hadoop/conf/hdfs_dn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      export HADOOP_JOURNALNODE_OPTS="$HADOOP_JOURNALNODE_OPTS -Djava.security.auth.login.config=/usr/hdp/3.1.0.0-78/hadoop/conf/hdfs_jn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      ...
      export HDFS_ZKFC_OPTS="-Dzookeeper.sasl.client=true -Dzookeeper.sasl.client.username=zookeeper -Djava.security.auth.login.config=/usr/hdp/3.1.0.0-78/hadoop/conf/secure/hdfs_jaas.conf -Dzookeeper.sasl.clientconfig=Client $HDFS_ZKFC_OPTS"
